...
public class Main {
    ...
    /// <summary>
    /// Compresses a list of strings by counting the number of times a character appears in a row
    /// </summary>
    /// <param name="data">List of strings to compress</param>
    /// <returns>Compressed list of strings</returns>
    ...
    /// <summary>
    /// Decompresses a list of strings by repeating a character a number of times
    /// </summary>
    /// <param name="data">List of strings to decompress</param>
    /// <returns>Decompressed list of strings</returns>
